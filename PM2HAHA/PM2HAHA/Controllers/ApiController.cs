...
namespace PM2HAHA.Controllers
{
    ...
    public class ApiController : Controller
    {
        ...
        public static async Task<string> Apiget()
        {
            try
            {
                //"Chiang Rai", String[] province = new String[] { "Chiang Mai", "Lampang", "Lamphun", "Mae Hong Son", "Nan", "Phayao", "Phrae", "Uttaradit",
            ...
            String[] province = new String[] { "Chiang Mai", "Lampang"};
        ...
        public static async Task<APICall> fetch(string city)
        {
            var client = new WebClient();

            var json = client.DownloadString($"https://api.waqi.info/feed/{city}/?token=c5a40e7f8af3b6fac5f3ca3828fda8b05ec1e60a");
